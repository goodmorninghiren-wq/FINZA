...
1. Push code to [GitHub](https://github.com/goodmorninghiren-wq/FINZA)
2. Import the repo at [vercel.com/new](https://vercel.com/new)
3. Add environment variables from `.env.template`
4. Configure QuickBooks + Supabase redirect URLs for your Vercel domain
5. Deploy

**Full step-by-step guide:** [VERCEL_DEPLOY.md](./VERCEL_DEPLOY.md)

See also the [Multi-Tenant Setup Guide](./SETUP_GUIDE.md) for Supabase and QuickBooks setup per entity.
